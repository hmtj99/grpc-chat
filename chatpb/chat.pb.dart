...
class User extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('User', package: const $pb.PackageName('chat'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..aOS(2, 'name')
    ..aInt64(3, 'chatRoomNo', protoName: 'chatRoomNo')
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get chatRoomNo => $_getI64(2);
  @$pb.TagNumber(3)
  set chatRoomNo($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasChatRoomNo() => $_has(2);
  @$pb.TagNumber(3)
  void clearChatRoomNo() => clearField(3);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $fixnum.Int64 get chatRoom => $_getI64(3);
  @$pb.TagNumber(4)
  set chatRoom($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
...
class Connect extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Connect', package: const $pb.PackageName('chat'), createEmptyInstance: create)
    ..aOM<User>(1, 'user', subBuilder: User.create)
    ..aOB(2, 'active')
    ..aOB(3, 'wantsNewRoom', protoName: 'wantsNewRoom')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.bool get wantsNewRoom => $_getBF(2);
  @$pb.TagNumber(3)
  set wantsNewRoom($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasWantsNewRoom() => $_has(2);
  @$pb.TagNumber(3)
  void clearWantsNewRoom() => clearField(3);
}
...
class BroadcastApi {
  ...
  $async.Future<Message> createStream($pb.ClientContext ctx, Connect request) {
    var emptyResponse = Message();
    return _client.invoke<Message>(ctx, 'Broadcast', 'CreateStream', request, emptyResponse);
  }
  $async.Future<Close> broadcastMessage($pb.ClientContext ctx, Message request) {
    var emptyResponse = Close();
    return _client.invoke<Close>(ctx, 'Broadcast', 'BroadcastMessage', request, emptyResponse);
  }
}
